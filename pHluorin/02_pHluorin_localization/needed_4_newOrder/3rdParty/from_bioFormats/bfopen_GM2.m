function [result, numImages] = bfopen_GM2(id, avgFlag, indxFrames, quietFlag ,varargin)
...
%% GM Nov. 2020
    ...
    for i = imagesIndexList
        ...
        if isempty(varargin) 
            ...
            arr = bfGetPlane(r, i, varargin{1}, varargin{2}, varargin{3}, varargin{4});
        end
       %% GM nov 2020 
...
%     result{s, 3} = colorMaps;
    ...
    if quietFlag == 0
        if isempty(varargin)
            ...
            elseif indxFrames == 1
                fprintf('The WHOLE movie was loaded baby!');
            end
            fprintf('\n');
        end
    end
